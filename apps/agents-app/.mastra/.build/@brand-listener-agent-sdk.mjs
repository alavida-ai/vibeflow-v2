...
var NEVER = INVALID;
var startWorkflowResultSchema = external_exports.object({
  runId: external_exports.string().optional(),
  suspendPayload: external_exports.any().optional(),
  status: external_exports.enum(["suspended"]).optional()
});
...
export { VibeflowAgentClient, getNextStep, getNextStepResultSchema, startWorkflow, startWorkflowResultSchema };
