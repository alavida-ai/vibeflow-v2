...
const SubMenuLink = ({ item }: { item: MenuItem }) => {
  return (
    <a
      className="flex flex-row gap-4 rounded-md p-3 leading-none no-underline transition-colors outline-hidden select-none hover:bg-muted hover:text-accent-foreground"
      href={item.url}
    >
